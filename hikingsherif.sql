...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 20, 2022 at 01:08 AM
...
INSERT INTO `investigation_requests` (`id`, `auditor_name`, `admin_id`, `issue_short_description`, `issue_details`, `request_date`, `status`, `hr_investigations`, `hr_action`, `hr_action_date`, `penatly`, `comments`) VALUES
(1, 'Ahmed', 1, 'test short desc', 'test detailed description', '2022-01-19', 'under investigation', 'still tracking', 'asd', '', '', ''),
