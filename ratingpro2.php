...
location.reload();
     ...
     if(!$con)
       echo"error conneting to db";
         ...
         // if($con->query($sql)===true){   
                 if($_POST['review']!=""){
                   $sql="INSERT INTO itemrating(itemid,itemname,stars,review) values('".$_GET['id']."','','".$_POST['phprating']."','".$_POST['review']."')";
          // ,'".$_POST['review']."'
          if($con->query($sql)===true)
  ...
  $sql="INSERT INTO itemrating(itemid,itemname,stars) values('".$_GET['id']."','','".$_POST['phprating']."')";
                 // ,'".$_POST['review']."'
                 if($con->query($sql)===true)
                //  echo "record inserted";
                echo "";
    ...
    $select_rating=mysqli_query($connect,"select * from itemrating where itemid=".$_GET['id']);
...
<div class="col-lg-3">
 ...
 <div class="col-lg-6">
    ...
    for($i=0;$i<floor($total_php_rating);$i++){
     ...
     echo   "<img src="."star2.png"." class="."rateimg".">";
...
<?php
    ...
    <div class="col-lg-6">
      <?php
    $select_rating=mysqli_query($connect,"select * from itemrating where itemid='".$_GET['id']."' and stars=".$i);
...
$query="select distinct review from itemrating where itemid=".$_GET['id'];
...
echo"<br>";
      ...
      echo  "<h1>no reviews yet! add the first one!</h1>";
    }
...
?>
  ...
  <div class="div">
      ...
      <img src="star1.png" class="rateimg" onmouseover="change(this.id);" id="php1" class="php">
      <input type="hidden"  id="php2_hidden" value="2" required>
      <img src="star1.png" class="rateimg" onmouseover="change(this.id);" id="php2" class="php">
      <input type="hidden" id="php3_hidden" value="3" required>
      <img src="star1.png" class="rateimg" onmouseover="change(this.id);" id="php3" class="php">
      <input type="hidden" id="php4_hidden" value="4" required>
      <img src="star1.png" class="rateimg" onmouseover="change(this.id);" id="php4" class="php">
      <input type="hidden" id="php5_hidden" value="5" required>
      <img src="star1.png" class="rateimg" onmouseover="change(this.id);" id="php5" class="php">
 
    </div>
    <h1><b>Add a review</b></h1>
 <div class="center">
      <input type="text" class="rev" name="review" >
